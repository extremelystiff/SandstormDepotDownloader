...
This tool is for Insurgency: Sandstorm, despite a lot of the naming scheme around this. This tool is origianlly made for Terraria by RussDev7. I will leave his readme here as the tool hasn't changed, just what game its downloading. Russ has made this entire Readme and the Tool, I've just changed a couple values to make it work for Insurgency: Sandstorm. 
